	...
	<view class="w-picker">
		...
		<view class="w-picker-cnt" :class="{'show':showPicker}">
			<view class="w-picker-hd" @touchmove.stop.prevent catchtouchmove="true">
			  <view class="w-picker-btn" style="text-align: left;" @tap="pickerCancel">取消</view>
			  <view class="w-picker-btn" style="color:#fd2f53;text-align: right;" @tap="pickerConfirm">确定</view>
			</view>
