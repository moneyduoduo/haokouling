<template>
	<view class="homeContent">
			...
			<view class="userInfoBar">
				<view class="userBox">
					...
					<view class="userName" v-else>
						<view class="name">Hi~欢迎来到集享</view>
						<view class="login" @click="login">注册/登录</view>
					</view>
				</view>
		<!-- 		<view class="moneyBar iconfont">
					<view class="money">{{withdrawMoney}}</view>
					<view class="moneyMoer" @click="tixian">账户余额(元)</view>
				</view> -->
			...
			<view class="moneyInfoBar">
				<view class="moneyInfo">
					<image class="userLevel" src="/static/image/home/vip1.png" v-if="isLogin">
					</image>
		...
		<view class="homeContentMain" :style="{marginTop: (statusBarHeight*2+240)+'upx'}">
			<view class="myOrderBar">
				<view class="orderTitle">
					<view class="title">我的订单</view>
					<view class="orderMoer iconfont" @tap="goOrder(0,0,0)">查看全部</view>
				</view>
				<view class="orderListIcon">
					<view class="orderList" @tap="goOrder(0,0,1)">
						<view class="icon">
							<image src="/static/image/home/orderIcon_01.png"></image>
						</view>
						<view class="orderText">全部</view>
					</view>
					<view class="orderList" @tap="goOrder(1,0,1)">
						<view class="icon">
							<image src="/static/image/home/orderIcon_02.png"></image>
						</view>
						<view class="orderText">已付款</view>
					</view>
					<view class="orderList" @tap="goOrder(2,0,1)">
						<view class="icon">
							<image src="/static/image/home/orderIcon_03.png"></image>
						</view>
						<view class="orderText">已完成</view>
					</view>
					<view class="orderList" @tap="goOrder(3,0,1)">
						<view class="icon">
							<image src="/static/image/home/orderIcon_04.png"></image>
						</view>
						<view class="orderText">已失效</view>
					</view>
				</view>
			</view>
			...
			<view class="myInvite">
				<view class="inviteTitle">
					...
					<view class="inviteMoer" @tap="shareFc">
						<image src="/static/image/home/invitePic.jpg"></image>
					</view>
				</view>
				<view class="inviteListIcon">
					<view class="inviterList borderRight" @tap="goShouyi">
						<view class="icon_01">
							<image src="/static/image/home/inviteIcon_01.jpg" class="icon_01"></image>
						</view>
						<view class="inviteText">我的收益</view>
					</view>
					<view class="inviterList borderRight" @tap="goFans">
						<view class="icon_02">
							<image src="/static/image/home/inviteIcon_02.jpg" class="icon_02"></image>
						</view>
						<view class="inviteText">{{fansCount}}人</view>
					</view>
					<view class="inviterList" @tap="goOrder(2,0,2)">
						<view class="icon_03">
							<image src="/static/image/home/inviteIcon_03.jpg" class="icon_03"></image>
						</view>
						<view class="inviteText">{{orderCount}}个</view>
					</view>
				</view>
			</view>
			...
			<view class="homeBannerBar" @tap="goVip()">
				<view class="homeBanner">
					<image src="/static/image/home/homeBanner.jpg">
				</view>
			</view>
			...
			<view class="linkIconListBar">
				<view class="linkIconList">
					...
					<view class="iconBox"  @tap="goSetCode">
						<view class="icon icon-temp">
							<image src="/static/image/home/setcode.png"></image>
						</view>
						<view class="text">定制邀请码</view>
					</view>
					<view class="iconBox" @tap="goChangeTel">
						<view class="icon icon-temp">
							<image src="/static/image/home/genghuanshoujihao.png"></image>
						</view>
						<view class="text">修改手机号</view>
					</view>
					<view class="iconBox" @tap="resetPassword">
						<view class="icon icon-temp">
							<image src="/static/image/home/zhongzhimima.png"></image>
						</view>
	...
	export default {
		...
		methods: {
			...
			async getdata() {
				...
				this.gradeIcon = '/static/image/home/level_' + this.grade + '.png'
 ...
 */
	...
	.icon-temp {
		background: linear-gradient(125deg, #f44141, #fd7e7d);
		border-radius: 8upx;
		display: flex;
		align-items: center;
		justify-content: center;
...
/* 	.left-text::before {
	...
	.homeContentMain .myOrderBar {
		padding: 20rpx;
		background: #fff;
		border-radius: 20rpx;
	}

	.homeContentMain .myOrderBar .orderTitle {
		display: flex;
		justify-content: space-between;
		align-items: center;
	...
	.homeContentMain .myOrderBar .orderTitle .title {
		font-size: 32rpx;
		flex: 1;
	}

	.homeContentMain .myOrderBar .orderTitle .orderMoer {
		width: auto;
		position: relative;
		font-size: 24rpx;
		color: #989898;
	...
	.homeContentMain .myOrderBar .orderTitle .orderMoer::before {
		content: '\E633';
		position: absolute;
		top: 4rpx;
		right: 0;
	...
	.homeContentMain .myOrderBar .orderListIcon {
		display: flex;
		justify-content: center;
		align-items: center;
		margin-top: 20rpx;
	...
	.homeContentMain .myOrderBar .orderListIcon .icon {
		width: 80rpx;
		height: 60rpx;
		margin: auto;
	}

	.homeContentMain .myOrderBar .orderListIcon .icon image {
		width: 100%;
		height: 100%;
	}

	.homeContentMain .myOrderBar .orderListIcon .orderText {
		text-align: center;
		color: #5b5b5b;
	}

	.homeContentMain .myInvite {
		padding: 20rpx;
		background: #fff;
		border-radius: 20rpx;
		margin-top: 20rpx;
	...
	.homeContentMain .myInvite .inviteTitle {
		display: flex;
		justify-content: space-between;
		align-items: center;
		padding-bottom: 20rpx;
	...
	.homeContentMain .myInvite .inviteTitle .title {
		font-size: 32rpx;
		flex: 1;
	}

	.homeContentMain .myInvite .inviteTitle .inviteMoer {
		width: 126rpx;
		height: 43rpx;
	}

	.homeContentMain .myInvite .inviteTitle .inviteMoer image {
		width: 100%;
		height: 100%;
	}

	.homeContentMain .myInvite .inviteListIcon {
		display: flex;
		justify-content: center;
		align-items: center;
		margin-top: 40rpx;
	...
	.homeContentMain .myInvite .inviteListIcon .borderRight {
		border-right: 1px solid #eeeeee;
	}

	.homeContentMain .myInvite .inviteListIcon .icon_01 {
		width: 44rpx;
		height: 47rpx;
		margin: auto;
	}

	.homeContentMain .myInvite .inviteListIcon .icon_02 {
		width: 98rpx;
		height: 47rpx;
		margin: auto;
	}

	.homeContentMain .myInvite .inviteListIcon .icon_03 {
		width: 139rpx;
		height: 47rpx;
		margin: auto;
	}

	.homeContentMain .myInvite .inviteListIcon .inviteText {
		text-align: center;
		margin-top: 10rpx;
		color: #5b5b5b;
	}
